...
namespace BloodBank.Controllers.Transaction
{
    public class T12201Controller : Controller
    {
        ...
        private IT12201 repository;
        private IError err;
        public T12201Controller(IT12201 ObjectIRepository, IError errorReport)
        {
        ...
        public ActionResult ChekApheresis(string patNo, string epsot)
        {
            try
            {
                string lang = Session["T_LANG"].ToString();
                var data = repository.ChekApheresis(patNo, epsot);
                string JSONString = string.Empty;
                JSONString = JsonConvert.SerializeObject(data);
                return Json(JSONString, JsonRequestBehavior.AllowGet);
            }
        ...
        private void PrintData(object sender, PrintPageEventArgs e)
        {
            try
            {
                ...
                e.Graphics.DrawString(" * " + patno + " * ", arial_Narrow9B, Brushes.Black, 230, 121, new StringFormat());
                CalcuateMargin(e);
                ...
                e.Graphics.DrawString("BB EPS# " + episodeno, arial_Narrow9B, Brushes.Black, 375, 85, new StringFormat());
                CalcuateMarginRegular(e);
