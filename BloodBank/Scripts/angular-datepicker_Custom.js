...
(function withAngular(angular, navigator) {
  ...
  var A_DAY_IN_MILLISECONDS = 86400000
      ...
      return [
        '<div class="_720kb-datepicker-calendar-header">',
          ...
          '<div class="_720kb-datepicker-calendar-header-middle _720kb-datepicker-calendar-month">',
            '{{month}}&nbsp;',
            '<a href="javascript:void(0)" ng-click="paginateYears(year); showYearsPagination = !showYearsPagination;imran=!imran">',
              '<span>',
                '{{year}}',
    ...
    , generateDaysColumns = function generateDaysColumns() {
      ...
      return [
      '<div class="_720kb-datepicker-calendar-days-header" ng-show="imran">',
    ...
    , generateDays = function generateDays() {
      ...
      return [
        '<div class="_720kb-datepicker-calendar-body" ng-show="imran">',
          ...
          '</div>',
          '<div>',
              '<label ng-click="setToDay_imran()" class="_today_imran">Today</label>',
          '</div>',
        '</div>'
      ];
    }
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton, preventMobile) {
        ...
        '<div class="_720kb-datepicker-calendar {{datepickerClass}} {{datepickerID}}" ng-class="{\'_720kb-datepicker-forced-to-open\': checkVisibility()}" ng-show="opnDiv" ng-blur="hideCalendar()">',
        '</div>'
      ]
      ...
      var linkingFunction = function linkingFunction($scope, element, attr) {
        ...
        var selector = attr.selector
          ...
          , dateEnabledDates = $scope.$eval($scope.dateEnabledDates)
            ...
            , datepickerDblclick = $scope.$eval($scope.datepickerDblclick)
          , date = new Date()
          , isMouseOn = false
        ...
        $scope.hideCalendar = function hideCalendar() {
          ...
          if (datepickerDblclick==undefined) {
              $scope.opnDiv = true;
          } else {
              $scope.opnDiv = datepickerDblclick;

          }
          //$scope.opnDiv = true;
          //$scope.opnDiv = datepickerDblclick;
          $scope.dtpkrDbclk = function dtpkrDbclk() {
              debugger;
             
          }
          //$scope.opnDiv = $scope.datepickerDblclick;
          //$scope.chekDoubleClick = function chekDoubleClick(e) {
          //    $scope.opnDiv = e;
          //} 
        ...
        $scope.setDatepickerDay = function setDatepickerDay(day) {
          ...
          $scope.setToDay_imran = function setToDay_imran() {
              var dt = new Date();
        ...
        $scope.paginateYears = function paginateYears(startingYear) {
          ...
          if ($scope.dateMinLimit &&
            ...
            //if ($scope.imran===false) {
            //    $scope.imran = true;
            //    console.log($scope.imran);
            //}
            //if ($scope.imran === true) {
            //    $scope.imran = false;
            //    console.log($scope.imran);
