app.controller("T12349Controller", ["$scope", "$filter", "$http", "$window", "T12349Service", "Data",
    function ($scope, $filter, $http, $window, T12349Service, Data) { //$location,
        ...
        function clear() {
            ...
            var bagTypeList = T12349Service.getBagType();
        ...
        $scope.onNextClick = function (u, fD, tD) {
            if ($scope.obj.selected === '1') {
                ...
                var getUnitList = T12349Service.getUnitList(u, f, t);
        ...
        $scope.validateUnit = function (e, i) {
            ...
            if (e.keyCode === 13 || e.keyCode === 9) {
                ...
                var validateWeight = T12349Service.validateWeight(weight, bagType);
        ...
        $scope.onRecieve = function (e, i) {
            ...
            if (e === true && weight !== null) {
                var getReciever = T12349Service.getReciever();
        ...
        $scope.insert = function () {
            ...
            if (a.length > 0) {
                var insert = T12349Service.insert(a);
        ...
        function CheckUnit(unitNo) {
            ...
            var bloodUnitData = T12349Service.getUnitData(unitNo);
