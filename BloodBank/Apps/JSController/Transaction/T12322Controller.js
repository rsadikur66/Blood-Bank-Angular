app.controller("T12322Controller", ["$scope", "T12322Service", "Data", "$window", "$filter",
    function ($scope, T12322Service, Data, $window, $filter) {
        $scope.obj = {};        
        $scope.obj = Data;    
        ...
        function getProductList() {
            var pdList = T12322Service.GetProductList();
        ...
        function getReasonList() {
            var rsList = T12322Service.GetReasonList();
        ...
        function GetSingleUnit(u, i) {
            if ($scope.obj.T12322[i].chk == 1) {
                if (u != null || u != '') {
                var data = T12322Service.GetSingleUnit(u);
            ...
            $scope.obj.onSave = function () {
                ...
                if (t122.length > 0) {
                    ...
                    if (prodChk.length > 0) {
                        ...
                        var saveList = T12322Service.saveList(sObj);
