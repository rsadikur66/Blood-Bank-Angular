app.service("T12349Service", ["$http", "vrtlDirr", function ($http, vrtlDirr) {
    var dataT12349 = {
    ...
    function getBagType() {
        try {
            var url = vrtlDirr + '/T12349/getBagType';
            var params = {};
            return $http({
                url: url,
                method: "POST",
    ...
    function getUnitList(u,f,t) {
        try {
            var url = vrtlDirr + '/T12349/getUnitList';
    ...
    function validateWeight(w,b) {
        try {
            var url = vrtlDirr + '/T12349/validateWeight';
    ...
    function getReciever() {
        try {
            var url = vrtlDirr + '/T12349/getReciever';
            var params = {};
            return $http({
                url: url,
                method: "POST",
    ...
    function insert(e) {
        try {
            var url = vrtlDirr + '/T12349/insert';
